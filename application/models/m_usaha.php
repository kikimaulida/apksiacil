...
class m_usaha extends CI_Model {
	...
	{
		return $this->db->query("SELECT tb_usaha.id_usaha, tb_usaha.nama_usaha, tb_usaha.deskripsi, tb_usaha.alamat, tb_usaha.jam_operasional, tb_usaha.telepon, tb_usaha.foto_usaha, tb_usaha.status, tb_usaha.bergabung, tb_pengguna.id_pengguna, tb_pengguna.nama_lengkap, tb_kategori.id_kategori, tb_kategori.nama_kategori, tb_kecamatan.id_kecamatan, tb_kecamatan.nama_kecamatan FROM tb_pengguna JOIN tb_usaha ON tb_pengguna.id_pengguna = tb_usaha.id_pengguna JOIN tb_kategori ON tb_kategori.id_kategori = tb_usaha.id_kategori JOIN tb_kecamatan ON tb_kecamatan.id_kecamatan = tb_usaha.id_kecamatan WHERE tb_usaha.id_usaha = '$id_usaha'");
	}
